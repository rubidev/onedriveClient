...
from onedrived.od_models.webhook_notification import WebhookNotification
...
def get_webhook_server(context):
    ...
    if context.config['webhook_type'] == 'direct':
        from onedrived.od_webhooks.http_server import WebhookConfig, WebhookListener
        ...
        from onedrived.od_webhooks.ngrok_server import WebhookConfig, WebhookListener
